...
(base) bgu@z30b:~/../TrulyFreeOCR$
(base) bgu@z30b:~/../TrulyFreeOCR$ ./jdk/bin/java -jar build/libs/trulyfreeocr.jar --settings settings.jsonc --threads 4 ./tests/eval-corpus/sherlock-holmes-010p.pdf
...
(base) bgu@z30b:~/../TrulyFreeOCR$
(base) bgu@z30b:~/../TrulyFreeOCR$ ./jdk/bin/java -jar build/libs/trulyfreeocr.jar --settings settings.jsonc --threads 1 ./tests/eval-corpus/sherlock-holmes-010p.pdf
